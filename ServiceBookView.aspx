<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ServiceBookView.aspx.cs" Inherits="ServiceBookView" %>
...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
           <center> 
               <br />
               Service Book View</legend></center>
        </div>
        <br />
        <!-- panel preview -->
    ...
    <div class="form-w3agile col-lg-offset-1">
                ...
                <td style="width: 100px; height: 28px;" align="left">
                    <asp:Button ID="Button1" runat="server" Text="Search" Font-Names="Cambria" 
                        ...
                        OnClientClick="return validate();" onclick="Button1_Click"  /></td>
                                        <td style="width: 100px; height: 28px;" align="left">
                    <asp:Button ID="Button3" runat="server" Font-Names="Cambria" Font-Size="Medium" 
                        onclick="Button3_Click1" Width="145px" Text="Mail" />
                </td>
       ...
       <div >
           <asp:GridView  Width="100%" ID="GridView1" runat="server" BackColor="White" BorderColor="#3366CC"
