<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="DesignationRemove.aspx.cs" Inherits="DesignationRemove" Title="Untitled Page" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
	...
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Designation&nbsp; Remove</legend></center>
        </div>
 ...
 <div class="col-md-4">	<img src="images/dbr.png" style="float:right;" /></div>
            ...
            <div >
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Enter The code</label>
                        <div class="col-sm-9">
     ...
     <table>
            <tr>
                ...
                <td style="width: 100px; height: 28px;" align="left">
                    <asp:Button ID="Button2" runat="server" Text="Logout" Font-Names="Cambria" 
                        Font-Size="Medium" Width="143px"  TabIndex="23"  
