<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ServiceRemove.aspx.cs" Inherits="ServiceRemove" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
	...
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Service Book Remove</legend></center>
        </div>
