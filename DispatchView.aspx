<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="DispatchView.aspx.cs" Inherits="DispatchView" %>
...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Dead Master View</legend></center>
        </div>
        <br />
        <!-- panel preview -->
            ...
            <div >
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Ref No</label>
                        <div class="col-sm-9">
