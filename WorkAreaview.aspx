<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="WorkAreaview.aspx.cs" Inherits="WorkAreaview" EnableEventValidation="false" %>
 ...
 <div class="container">
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>
               <br />
               WorkArea Master View</legend></center>
        </div>
        <br />
        <!-- panel preview -->
