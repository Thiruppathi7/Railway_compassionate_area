<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wRemove.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="wRemove" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
	...
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Work Area Remove</legend></center>
        </div>
