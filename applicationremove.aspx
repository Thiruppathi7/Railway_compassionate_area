<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="applicationremove.aspx.cs" Inherits="applicationremove" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
	...
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Application&nbsp; Remove</legend></center>
        </div>
 ...
 <div class="col-md-4">	<img src="images/dbr.png" style="float:right;" /></div>
            ...
            <div >
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">Enter The Pfno</label>
                        <div class="col-sm-9">
    ...
    <div class="form-w3agile" style="margin-left:27em;">
     <table>
            <tr>
