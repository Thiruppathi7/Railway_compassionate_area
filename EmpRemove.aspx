<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpRemove.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="EmpRemove" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
	...
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Employee Remove</legend></center>
        </div>
