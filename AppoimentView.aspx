<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="AppoimentView.aspx.cs" Inherits="AppoimentView" %>
...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>
               <br />
               Appoiment Master View</legend></center>
        </div>
        <br />
        <!-- panel preview -->
            ...
            <div >
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label">SNO</label>
                        <div class="col-sm-9">
