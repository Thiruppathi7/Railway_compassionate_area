<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="VerficationView.aspx.cs" Inherits="VerficationView" %>
...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>
               <br />
               Verfication View</legend></center>
        </div>
        <br />
        <!-- panel preview -->
