<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="Changepwd.aspx.cs" Inherits="Default2" Title="Untitled Page" %>
	...
	<div class="row">
                ...
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <asp:ListItem>Dead Person Master</asp:ListItem>
                            <asp:ListItem>Application Matser</asp:ListItem>
                            <asp:ListItem>Appointment Master</asp:ListItem>
       ...
       <center> <table>
            <tr>
                ...
                <td style="width: 100px; height: 28px;"><asp:Button ID="Button3" runat="server" 
                        Text="Modify" Font-Names="Cambria" Font-Size="Medium" Width="143px"  
                        TabIndex="25"  /></td>
                <td style="width: 100px; height: 28px;"><asp:Button ID="Button4" runat="server" 
                        Text="View" Font-Names="Cambria" Font-Size="Medium" Width="143px"  
                        TabIndex="26"  /></td>
                <td style="width: 100px; height: 28px;"><asp:Button ID="Button5" runat="server" 
