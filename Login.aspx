...
<!--login-->
	...
	<div class="login"><div class="row">
			<div class="col-md-4">	<img src="images/login-img.png" height=300 width=300 style="float:right;" /></div>
<div class=" col-md-6 main-agileits">
		<div class="form-w3agile">
					<h3>Login</h3>
					<form action="#" runat="server" method="post">
					<div class="key">
					<asp:DropDownList ID="DropDownList5" name="type" class="form-control" 
						...
						<div class="key">
                            ...
                            <asp:TextBox ID="TextBox1"  name="Username" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'username';}" required="" runat="server"></asp:TextBox>
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
                            <asp:TextBox ID="TextBox2" onFocus="this.value = '';" 
...
<div class="footer">
	<div class="container">
	  <div class="copy-right">
				<p> © 2023 Southern Railway Madurai Division. All Rights Reserved | Design by  <a href="#">  SAndy</a></p>
	  </div>
  </div>
</div>
<!-- //footer-->
