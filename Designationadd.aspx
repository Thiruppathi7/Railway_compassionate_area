<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="Designationadd.aspx.cs" Inherits="Default2" Title="Untitled Page" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
    ...
    if (gender == "") {
        alert("Enter the DesignationName");
        return false;
    }
 ...
 <div class="container">
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Designation Add</legend></center>
        </div>
            ...
            <div >
                <div class="panel-body form-horizontal payment-form">
                    <div class="form-group">
                        <label for="concept" class="col-sm-3 control-label"> Designation Code</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="description" class="col-sm-3 control-label">Designation Name</label>
                        <div class="col-sm-9">
