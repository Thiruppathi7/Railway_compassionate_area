<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Examremove.aspx.cs" Inherits="Examremove" Title="Untitled Page" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
	...
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Exam Remove</legend></center>
        </div>
