<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpMasterReport.aspx.cs" Inherits="EmpMasterReport" MasterPageFile="~/admin.master" %>
...
<br />
    ...
    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" 
        ...
        EnableParameterPrompt="False" /></center>
</asp:Content>
