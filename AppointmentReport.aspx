<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppointmentReport.aspx.cs" Inherits="EmpMasterReport" MasterPageFile="~/admin.master" %>
    ...
    <tr>
        <td>
            <asp:Label ID="Label1" runat="server" Font-Names="Lucida Calligraphy" 
                Text="Enter the Code" Width="200px"></asp:Label>
        </td>
        <td>
