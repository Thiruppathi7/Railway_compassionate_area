<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DipatchRemove.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="DeadpersonRemove" %>
  ...
  function validate() 
{
   var Reward = document.getElementById('<%= TextBox1.ClientID %>').value;
	...
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>Dispatch Remove</legend></center>
        </div>
