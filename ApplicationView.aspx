<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ApplicationView.aspx.cs" Inherits="ApplicationView" %>
...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
           <center> <legend>
               <br />
               Application View Master</legend></center>
        </div>
        <br />
        <!-- panel preview -->
